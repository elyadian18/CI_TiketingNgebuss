...
<form action="<?= base_url('pesanTiket') ?>" method="POST"> 
    <div class="card">
        ...
        <div class='card-body'>        
            <div class='form-group form-inline'>
                ...
                <div class='col-md-9'>
                    <input class = "form-control" readonly disable type="text" value='<?= $info->nama_kota ?>'>
                </div>
            </div>
            <div class='form-group form-inline'>
                <div class='col-md-2'>
                ...
                <div class='col-md-9'>
                    <input class = "form-control" readonly disable type="text" value='<?= $info->tgl_berangkat ?>'>
                </div>
            </div>
            <div class='form-group form-inline'>
                <div class='col-md-2'>
                ...
                <div class='col-md-9'>
                    <input class = "form-control" readonly disable type="text" value='<?= $info->tgl_sampai ?>'>
                </div>
            </div>
            <div class='form-group form-inline'>
                <div class='col-md-2'>
                ...
                <div class='col-md-9'>
                    <span>Dari</span>
                    <input class = "form-control" readonly disable type="text" value='<?= $info->ASAL ?>'>
                    <span>Ke</span>
                    <input class = "form-control" readonly disable type="text" value='<?= $info->TUJUAN ?>'>
                </div>
            </div>
            <div class='form-group form-inline'>
                <div class='col-md-2'>
                ...
                <div class='col-md-9'>
                    <input class = "form-control" readonly disable type="text" value='<?= $_GET['p'] ?>'>
                </div>
            </div>
            <div class='form-group form-inline'>
                <div class='col-md-2'>
                ...
                <div class='col-md-9'>
                    <input class = "form-control" readonly disable type="text" value='<?= 'Rp. '.number_format($info->harga,0,',','.') ?>'>
                </div>
            </div>
        </div>
    </div>
    ...
    <input type="hidden" name="nama_kota" value="<?= $info->nama_kota ?>">
    <input type="hidden" name="tgl_berangkat" value="<?= $info->tgl_berangkat ?>">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <input type="text" class="form-control" name="no_identitas<?= $i ?>" required>
                        </td>
                    </tr>
                    <?php endfor ?>
                </tbody>
    ...
    <br>      
    <div class ='card'>
        <div class ="card-header bg-primary text-white">Detail Pemesanan</div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
